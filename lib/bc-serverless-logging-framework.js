...
exports.bcLogger = void 0;
const Levels_1 = require("./bc-serverless-logging-framework/enums/Levels");
const destinations_1 = require("./bc-serverless-logging-framework/destinations");
const createLog_1 = require("./bc-serverless-logging-framework/util/createLog");
const transport_1 = require("./bc-serverless-logging-framework/util/transport");
...
exports.bcLogger = {
    ...
    create({ levels, props, computed, transports, errorKey, propsRoot } = {}) {
        ...
        if (!(levels === null || levels === void 0 ? void 0 : levels.length)) {
            levels = Object.values(exports.bcLogger.levels);
        }
        if (!errorKey) {
            errorKey = 'error';
        }
        if (!(transports === null || transports === void 0 ? void 0 : transports.length)) {
            console.warn('Warning: no transports added to bcLogger. Logging functionality is disabled');
        }
        if (props && propsRoot) {
            const rootedProps = {};
        ...
        const logger = {
            ...
            child(childConfig, options) {
                ...
                return exports.bcLogger.create(conf);
            },
            /**
